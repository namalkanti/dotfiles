...
#Aider aliases
alias aider='aider --chat-mode ask --cache-prompts --no-gitignore --no-auto-commits --subtree-only --model anthropic/claude-sonnet-4-6 --weak-model anthropic/claude-haiku-4-5-20251001'
